        ...
        <div class="col-md-10">
            <div class="card shadow-sm">
                <div class="card-header bg-success text-white">
                    <h5 class="mb-0">
                        <i class="fas fa-film me-2"></i>Registrar Nueva Película
                    </h5>
                </div>

                <div class="card-body">
                    <form method="post" action="{{ route('peliculas.store') }}" class="g-3">
                        @csrf
                                ...
                                <select class="form-select @error('id_clasificacion') is-invalid @enderror"
                                    ...
                                    @foreach($clasificaciones as $clasificacion)
                                        <option value="{{ $clasificacion->id_clasificacion }}"
                                            {{ old('id_clasificacion') == $clasificacion->id_clasificacion ? 'selected' : '' }}>
                                ...
                                <select class="form-select @error('id_director') is-invalid @enderror"
                                    ...
                                    @foreach($directores as $director)
                                        <option value="{{ $director->id_director }}"
                                            {{ old('id_director') == $director->id_director ? 'selected' : '' }}>
