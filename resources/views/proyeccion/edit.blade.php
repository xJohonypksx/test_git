...
@section("content")
    ...
    <form action="{{ route('proyecciones.update', $proyeccion->id_proyeccion) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="precio" name="precio" value="{{ $proyeccion->precio }}" step="0.01" required>
        </div>

        <button type="submit" class="btn btn-primary">Actualizar Proyección</button>
    </form>
